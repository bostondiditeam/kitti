...
This file describes the KITTI object detection and orientation estimation
benchmarks, consisting of 7481 training images and 7518 test images for each
task. Despite the fact that we have labeled 8 different classes, only the
...
The goal in the object detection task is to train object detectors for the
...
objects larger than 25 pixel (height) in the image and do not count Vans as
false positives for cars or Sitting Persons as wrong positives for Pedestrians
